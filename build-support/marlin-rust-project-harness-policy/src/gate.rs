...
use crate::{
    RustProjectHarnessEvidenceReceipt, assert_rust_harness_dependency_topology_receipt_from_env,
...
pub fn complete_build_gate(
    ...
    let _dependency_topology_receipt =
        assert_rust_harness_dependency_topology_receipt_from_env(project_root);
