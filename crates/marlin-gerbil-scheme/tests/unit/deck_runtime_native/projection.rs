...
fn native_aot_plan() -> GerbilDeckRuntimeNativeAotPlan {
    GerbilDeckRuntimeNativeAotPlan {
        ...
        scheme_source: PathBuf::from("/tmp/marlin-native/runtime.ss"),
        header: PathBuf::from("/tmp/marlin-native/runtime.h"),
        generated_loader_scm: PathBuf::from("/tmp/marlin-native/out/loader.scm"),
        generated_runtime_scm: PathBuf::from("/tmp/marlin-native/out/runtime.scm"),
        generated_ssi: PathBuf::from("/tmp/marlin-native/out/runtime.ssi"),
        generated_ssxi: PathBuf::from("/tmp/marlin-native/out/runtime.ssxi"),
        static_scm: PathBuf::from("/tmp/marlin-native/out/runtime-static.scm"),
        ...
        gxc_generate_scheme: command_plan("gxc"),
