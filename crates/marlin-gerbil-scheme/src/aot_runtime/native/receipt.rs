...
pub struct GerbilDeckRuntimeNativeAotPlan {
    ...
    pub compiled_runtime_dependency_scms: Vec<PathBuf>,
    pub header: PathBuf,
    pub object: PathBuf,
    pub dependency_objects: Vec<PathBuf>,
    ...
    pub gsc_compile_dependency_objects: Vec<GerbilDeckRuntimeNativeAotCommandPlan>,
...
pub struct GerbilDeckRuntimeNativeAotBuildReceipt {
    ...
    pub gsc_compile_dependency_objects: Vec<GerbilDeckRuntimeNativeAotCommandReceipt>,
