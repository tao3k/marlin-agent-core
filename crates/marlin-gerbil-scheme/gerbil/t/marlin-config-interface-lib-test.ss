...
;;; Boundary: Presentation shows the complete Marlin policy facade contract.
;; MarlinResult <- MarlinInput
...
(check (.get modules-lib-root kind) => marlin-config-interface-kind)
...
(modules-lib-assert-equal
 (.get modules-lib-policy-pack-presentation-now policy-facade-presentation-kind)
 marlin-policy-facade-presentation-kind
 "presentation policy facade kind mismatch")
(modules-lib-assert-equal
