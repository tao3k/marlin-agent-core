...
(check (vector-length policy-combination-slot-merge-algebra-receipts) => 6)
...
(check (.get (vector-ref policy-combination-slot-merge-algebra-receipts 4)
             merge)
       => "union")
(check (.get (vector-ref policy-combination-slot-merge-algebra-receipts 5) slot)
       => "exclusive_resource")
(check (.get (vector-ref policy-combination-slot-merge-algebra-receipts 5)
             merge)
       => "conflict_error")
(check (.get (vector-ref policy-combination-slot-merge-algebra-receipts 5)
             status)
...
(check (.get (vector-ref policy-combination-slot-merge-algebra-receipts 5)
             result)
       => "workspace-write")
(check (vector-length policy-combination-slot-merge-audit-receipts) => 6)
(check (.get (vector-ref policy-combination-slot-merge-audit-receipts 0)
             status)
       => "applied")
(check (.get (vector-ref policy-combination-slot-merge-audit-receipts 5)
             status)
       => "applied")
(check (vector-length policy-combination-merge-receipts) => 6)
...
(check (.get (vector-ref policy-combination-merge-receipts 4) merge)
       => (.get (vector-ref policy-combination-slot-merge-audit-receipts 4)
                merge))
(check (.get (vector-ref policy-combination-merge-receipts 5) slot_id)
       => (.get (vector-ref policy-combination-slot-merge-audit-receipts 5)
                slot_id))
(check (.get (vector-ref policy-combination-merge-receipts 5) merge)
       => (.get (vector-ref policy-combination-slot-merge-audit-receipts 5)
                merge))
(check (vector-length (.get policy-combination-audit-pack forced_slots)) => 6)
(check (.get (vector-ref (.get policy-combination-audit-pack forced_slots) 4)
             hotness)
       => "audit_only")
(check (.get (vector-ref (.get policy-combination-audit-pack forced_slots) 5)
             hotness)
       => "hot")
