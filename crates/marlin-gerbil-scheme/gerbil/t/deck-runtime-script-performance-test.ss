...
;;; Boundary: Definition keeps a parser-owned edit boundary for policy repair.
;; MarlinResult <- MarlinInput
(def (check-deck-runtime-script-performance-contract)
  (let* ((context (.o command: "codex perf-script apply"
...
(check-deck-runtime-script-performance-contract)
