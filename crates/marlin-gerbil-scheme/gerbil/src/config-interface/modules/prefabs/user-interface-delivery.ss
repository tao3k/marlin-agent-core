...
(def user-interface-delivery-receipt-kind
  "marlin.config-interface.prefabs.user-interface.delivery-receipt.v1")
...
(def (UserInterfaceDeliveryReceipt workspace-config)
  (let* ((workflow (UserInterfaceWorkspaceWorkflow workspace-config))
         ...
         (policy-facade-presentation-kind-value
          (.get pack-presentation policy-facade-presentation-kind))
         (policy-facade-projection-chain-kind-value
          (.get pack-presentation policy-facade-projection-chain-kind))
    ...
    (.o kind: user-interface-delivery-receipt-kind
        ...
        policy-facade-presentation-kind: policy-facade-presentation-kind-value
