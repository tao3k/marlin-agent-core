...
(def (marlinDefaultLoopEngineReceiptContracts)
  '(((id . "lineage-receipt")
    ...
    ((id . "selector-receipt")
     ...
     (owner . "poo-flow"))
    ((id . "session-agent-graph")
     (schema . poo-flow.modules.session.agent-graph.v1)
     (owner . "poo-flow"))
    ...
    ((id . "policy-extension-receipt")
     ...
     (owner . "poo-flow"))
    ((id . "spec-evolution-review")
     (schema . poo-flow.spec-evolution.review-item.v1)
     (owner . "poo-flow"))
    ((id . "spec-evolution-runtime-manifest-row")
     (schema . poo-flow.spec-evolution.runtime-manifest-row.v1)
     (owner . "poo-flow"))
